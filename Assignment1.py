...
# input_file = csv.DictReader(open("/home/mazharshah/Desktop/weatherdata/lahore_weather_1996_Dec.csv"))
#
# for row in input_file:
#     print row


# input_file = csv.DictReader(open('/home/mazharshah/Desktop/weatherdata/lahore_weather_1997_Dec.txt'))
...
for year in yearList:
    ...
    for month in monthList:
        file_to_Read = path + str(year) + "_" + str(month) + ".txt"
        # print file_to_Read
    ...
    yearlyData = [year, maxTemperature, minTemperature, max(maxHumidityList), min(minHumidityList)]

    #this is the ROW of Hottest day table
    hot_day_info = [year, dateMaxTempList[maxTempList.index(max(maxTempList))], maxTemperature]

    #this is the Row of Coldest Day table
    cold_day_info = [year, dateMinTempList[minTempList.index(minTemperature)], minTemperature]
    ...
    cold_day_data.append(cold_day_info) #Contains Every years's Coldest day and Temp
