...
class month_report(data):
    ...
    def generate_month_report(self,file_names):
        ...
        print("Average high temprature :{temp}".format(temp= statistics.mean(average_highest_temperature)))
        print("Average Low temprature :{temp}".format(temp = statistics.mean(average_lowest_temperature)))
        print("Average Mean humidity :{temp}".format(temp = statistics.mean(average_mean_humidity)))
