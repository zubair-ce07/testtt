...
class WebCrawlerAsync:
    ...
    def crawl(self, url):
        ...
        asyncio.ensure_future(self.crawl_page(), loop=self.loop)
        ...
        while True:
            ...
            while not self.crawlable_url.empty():
                ...
                if self.max_request_count > self.request_count:
                    asyncio.ensure_future(self.crawl_element(url), loop=self.loop)
    ...
    async def crawl_element(self, crawlable_url):
