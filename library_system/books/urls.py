...
urlpatterns = [
    ...
    path('issue/<int:pk>/', views.BookIssue, name='book_issue'),
    path('user_information/<int:pk>/', views.user_profile, name='user_profile'),
    path('request/<int:pk>/', views.BookRequest, name='book_request'),
