class WeatherReading:
	def __init__(self, PKT, MaxTemp, MeanTemp, MinTemp, Dew, MeanDew, MinDew, MaxHumidity, MeanHumidity, MinHumidity, MaxSeaPressure, MeanSeaPressure, 				MinSeaPressure, MaxVisibility, MeanVisibility, Minvisibility, MaxWindSpeed, MeanWindSpeed, MinWindSpeed, MaxGustSpeed, Precipitation, CloudCover, 				Events, WinDirDegrees):
