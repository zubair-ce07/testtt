...
class WeatherReportGenerator:
    def generate_yearly_report(self, yearly_result):
        ...
        print(f"Highest: {highest_temperature.high_temperature}C on {calendar.month_name[highest_temperature.date.month]} "
    ...
    def generate_monthly_temperatures_report(self, readings):
        for day_reading in readings:
            if day_reading.high_temperature and day_reading.low_temperature:
