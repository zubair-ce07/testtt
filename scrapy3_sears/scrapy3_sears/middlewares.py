...
class Scrapy3SearsSpiderMiddleware(object):
...
class Scrapy3SearsDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
# class BotManagementRedirectMiddleware(RedirectMiddleware):
#
...
#
#         self.dryscrape_session = dryscrape.Session(base_url='https://www.sears.com/en_us.html')
#
...
#         return 'botmanagement.html' in url