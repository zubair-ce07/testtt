...
YEAR_ARGUMENT_DISCRIPTION = "Takes a list of years in YYYY formate and display the highest"\
    " temperature and day, lowest temperature and day, most humid day and humidity."
MONTH_ARGUMENT_DISCRIPTION = "Takes a list of month in YYY/MM formate and display the average"\
