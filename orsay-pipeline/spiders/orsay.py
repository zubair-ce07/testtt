...
from orsay.spiders.products import Product
...
class OrsaySpider(Spider):
    ...
    def parse_pagination(self, response):
        ...
        for item_count in range(self.page_size, total_items, self.page_size):
            ...
            yield Request(url=self.add_query_params(response.url, add_query_params),
    ...
    def image_urls(self, response):
        ...
        return [self.add_query_params(url, add_query_params)
