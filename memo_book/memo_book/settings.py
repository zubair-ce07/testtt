"""
Django settings for memo_book project.
...
SECRET_KEY = '0wf@s^31vqk-s#_+fs6_^hlpitnff-xcnqt#l4ct-to7j#9h*3'
...
MIDDLEWARE = [
    ...
    'memoapp.middlewares.CheckSuperUserMiddleware',
    'debug_toolbar.middleware.DebugToolbarMiddleware',
]

ROOT_URLCONF = 'memo_book.urls'
...
WSGI_APPLICATION = 'memo_book.wsgi.application'
