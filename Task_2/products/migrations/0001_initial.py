...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('url', models.URLField()),
                ('retailer_sku', models.BigIntegerField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=50)),
                ('brand', models.CharField(blank=True, max_length=20, null=True)),
                ('description', models.CharField(blank=True, max_length=300, null=True)),
                ('fabric', models.CharField(blank=True, max_length=20, null=True)),
            ],
            options={
                'db_table': 'product',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=6)),
