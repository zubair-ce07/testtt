...
class WeatherReport:
    ...
    def calculate_extreme_for_year(weather_records):
        mean_records = WeatherReport.filter_records_by_attribute(weather_records, 'mean_temperature')
        humidity_records = WeatherReport.filter_records_by_attribute(weather_records, 'mean_humidity')
    ...
    def calculate_average_for_month(weather_records):
        high_records = WeatherReport.filter_records_by_attribute(weather_records, 'max_temperature')
        low_records = WeatherReport.filter_records_by_attribute(weather_records, 'min_temperature')
        humidity_records = WeatherReport.filter_records_by_attribute(weather_records, 'mean_humidity')
    ...
    @staticmethod
    def filter_records_by_attribute(weather_records, attribute):
