...
class Feedback(models.Model):
    given_by_user = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='given_feedback')
    given_to_user = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, related_name='received_feedback')
