# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-05 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='birthday', to='movies.Date')),
                ('deathday', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='deathday', to='movies.Date')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.AddField(
            model_name='movie',
            name='release_date',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.Date'),
        ),
        migrations.AddField(
            model_name='job',
            name='movie',
