...
class ReportGenerator:
    ...
    def drawBarCharts(self, requiredDays, allDataArray):
        for i in requiredDays:
            highest = "\033[0;34;m" + "+" * int(allDataArray[i].maxTemperature)
            lowest = "\033[0;31;m" + "+" * int(allDataArray[i].minTemperature)
            if (allDataArray[i].pkt[-2] == "-"):
                print("\033[0;30;m" +'0'+allDataArray[i].pkt[-1:], " ", highest, "\033[0;30;m" + allDataArray[i].maxTemperature, "C")
                print("\033[0;30;m" +'0'+allDataArray[i].pkt[-1:], " ", lowest, "\033[0;30;m" + allDataArray[i].minTemperature, "C")
            else:
