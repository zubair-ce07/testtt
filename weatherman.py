...
def display_charts_of_readings(given_date, weather_readings):
...
def main():
    ...
    for arg in args.month:
        display_average_readings(arg[0], readings)
    for arg in args.year:
        display_extreme_readings(arg[0], readings)
    for arg in args.chart:
        display_charts_of_readings(arg[0], readings)
