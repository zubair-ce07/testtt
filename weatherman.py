...
def barChart(lines, attribute):    
    ...
    while i != (len(lines)):
        ...
        if attribute == 1:
            maxVal = max(maxVal, int(line[attribute]))
            if int(line[attribute]) == maxVal:
                minVal = line[3]
                
        elif attribute == 3:
            minVal = min(minVal, int(line[attribute]))
            if int(line[attribute]) == minVal:
                maxVal = line[1]

    print('\033[31m' , "+" * int(maxVal), '\033[35m', maxVal,"C")
    print('\033[36m' ,"+" * int(minVal), '\033[35m', minVal,"C", '\033[0m')
    
    


def barChartBonus(lines, attribute):    
    i = 1
    minVal = 100
    maxVal = -100
    while i != (len(lines)):
    ...
    print('\033[36m' ,"+" * int(minVal) + '\033[31m', "+" * int(maxVal), '\033[35m', minVal,"C  -", '\033[35m', maxVal,"C", '\033[0m')
...
if __name__ == "__main__":
    ...
    if '-a' in sys.argv:
        ...
        lines = open('weatherfiles/' + fileName, "r").readlines()
    ...
    if '-c' in sys.argv:
        ...
        barChartBonus(lines,1)
        barChartBonus(lines,3)
        print("\n")
