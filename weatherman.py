...
def print_stats():
    ...
    print("Highest:", temp_stats["max_temp"], "C on",
          prettify_date(temp_stats["max_temp_date"]))
    print("Lowest:", temp_stats["min_temp"], "C on",
          prettify_date(temp_stats["min_temp_date"]))
    print("Humidity:", humidity_stats["max_humidity"], "% on",
          prettify_date(humidity_stats["max_humidity_date"]))
...
def process_file_for_minmax_stats(file_name):
    ...
    try:
        with open(file_name) as open_file:
            ...
            compute_incrementally_stats_minmax_month(
        ...
        if(i != 0):
            ...
            if(line[file_columns["Max_Humidity"]] is not ""):
                ...
                if((max_day_humidity) > humidity_stats["max_humidity"]):
                    ...
                    humidity_stats["max_humidity_date"] = line[
                        file_columns["PKT"]]
        i = i + 1
