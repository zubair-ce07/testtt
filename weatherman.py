...
def parse_arguments():
    ...
    parser.add_argument('-e', '--yearly', nargs = '*', help='yearly report', type=date_year, default='')
    parser.add_argument('-a', '--monthly', nargs = '*',help='monthly report', type=date_month, default='')
    parser.add_argument('-c', '--bar_chart', help='bar chart report', type=date_month, default='')
...
def main():
    ...
    if parsed_args.bar_chart:
        bar_chart_records = reports.generate_bar_chart_report(weather_records, parsed_args.bar_chart)
        reportgenerator.generate_bar_chart(bar_chart_records)
