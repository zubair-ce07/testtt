...
class Record:
    ...
    def __init__(self, date, highest_temp, lowest_temp, highest_humidity, avg_humidity):
        ...
        self.highest_humidity = int(
            highest_humidity) if highest_humidity.isdigit() else highest_humidity
        self.avg_humidity = int(
         avg_humidity) if avg_humidity.isdigit() else avg_humidity
