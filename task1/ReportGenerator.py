...
class ReportGenerator:
    ...
    def year_report(self):
        high_temp, high_temp_day = self.calculations_object.highest_temp_in_year(self.weather_data)
        low_temp, low_temp_day = self.calculations_object.lowest_temp_in_year(self.weather_data)
        humidity, humid_day = self.calculations_object.most_humid_day_of_year(self.weather_data)
    ...
    def month_report(self):
        high_temp = self.calculations_object.avg_highest_temp(self.weather_data)
        low_temp = self.calculations_object.avg_lowest_temp(self.weather_data)
        humidity = self.calculations_object.avg_mean_humidity(self.weather_data)
