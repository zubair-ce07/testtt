...
from ThermoFisher.items import ThermoType1SpiderItem, ThermoType2SpiderItem, ThermoType3SpiderItem
...
# Overview Item methods
    ...
    def compile_overview_item(self, response):
        ...
        item['specifications'] = self.get_product_specifications_overview(response)
    ...
    def get_product_specifications_overview(self, response):
