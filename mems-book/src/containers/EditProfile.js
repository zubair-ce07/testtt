...
class EditProfile extends Component {
    ...
    submit(values)
    {
       ...
       this.props.updateProfile(formData,this.props.initialValues.id, localStorage.getItem('token')).then(()=>{browserHistory.push('/home')})
    }
 ...
 <div className="col-md-7 col-md-offset-2">
                <form onSubmit={ handleSubmit(this.submit.bind(this)) }>
                    <center><h2> <b>Edit Your Profile</b> </h2></center> <br/>
