...
import {getMem, editMem, getCategories} from '../actions';
...
class EditMem extends React.Component {
    ...
    submit(values)
    {
       ...
       this.props.editMem(formData,this.props.initialValues.id, localStorage.getItem('token')).then(()=>{browserHistory.push('/home')})
    }
