...
urlpatterns = [
    ...
    path('rest/edit-profile/', login_required(views.RestUserEditFormView.as_view(), login_url='/rest/login'),
         name='rest_edit'),
    path('rest/change-password/', login_required(views.RestUserEditPassword.as_view(), login_url='/rest/login'),
