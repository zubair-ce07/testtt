...
urlpatterns = [
    url(r'^post/new/$', login_required(NewPostView.as_view()), name='new_post'),
    ...
    url(r'^post/(?P<post_id>\d+)/$', login_required(PostDetailsView.as_view()), name='post_details'),
    url(r'^post/(?P<post_id>\d+)/request/$', login_required(NewRequestView.as_view()), name='new_request'),
    url(r'^my-post/(?P<post_id>\d+)/$', login_required(MyPostDetailsView.as_view()), name='my_post_details'),
    url(r'^post/(?P<post_id>\d+)/request/(?P<request_id>\d+)/accept/$', login_required(AcceptRequestView.as_view()),
        name='accept_request'),
