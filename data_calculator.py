...
class DataCalculator:
    ...
    def monthly_analysis(self, extracted_data, date):
        records = self.monthly_records(extracted_data, date)
    ...
    def yearly_analysis(self, extracted_data, year):
        records = [record for record in extracted_data if record.date.year == year]
