...
class EditForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        userprofile.phone_number = self.cleaned_data.get('phone_number')
        userprofile.address = self.cleaned_data.get('address')
        userprofile.country = self.cleaned_data.get('country')
        if self.FILES.get('image'):
            userprofile.image = self.FILES.get('image')
