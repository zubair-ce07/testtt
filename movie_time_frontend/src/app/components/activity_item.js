    ...
    return (
        <div className="card mt-4 border-0">
            <h3 className="card-header bd-1">
                <img className="rounded-circle img-profile" src={user.photo === null? '/images/avatar.jpg': user.photo}/>
                ...
                <div className="float-right">
                    ...
                    {activity.rating === 'Liked' && renderAction('fa-thumbs-up', activity.id, actions.rated_at, 'Liked')}
                    {activity.rating === 'Disliked' && renderAction('fa-thumbs-down', activity.id, actions.rated_at, 'Disliked')}
                </div>
            </h3>
            ...
            <div className="card-block p-0">
                <MetaMovie movie={activity.movie} addToWatchlist={addToWatchlist} removeFromWatchlist={removeFromWatchlist}/>
            </div>
        </div>
    );
};
