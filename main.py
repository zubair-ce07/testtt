...
def parse_cmd_arguments():
    ...
    parser.add_argument("-c", type=ArgumentValidator.validate_month_year,
                        help="specify month for required information")
    parser.add_argument("-a", type=ArgumentValidator.validate_month_year,
                        help="specify month for required information")
...
def generate_weather_reports(cli_args):
    ...
    if cli_args.e:
        weather_reporter.generate_annual_report(cli_args.e.year, cli_args.dir_path)
    if cli_args.a:
        weather_reporter.generate_monthly_report(cli_args.a.year, cli_args.a.month,
                                                 cli_args.dir_path)
