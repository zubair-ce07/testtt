...
if __name__ == '__main__':
    ...
    while not taxi_ride.is_ride_ended:
        ...
        taxi_ride.taxi_meter_calc.calculate_ride_time(taxi_ride.is_ride_resumed,
                                                      taxi_ride.taxi_meter_calc.taxi_meter)
        taxi_ride.taxi_meter_calc.calculate_ride_fair(taxi_ride.taxi_meter_calc.taxi_meter)
        taxi_ride.taxi_meter_calc.calculate_ride_distance(taxi_ride.taxi_meter_calc.taxi_meter)
